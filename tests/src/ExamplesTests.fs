...
<| fun () ->
    ...
    // Simplest case
    it "example ReactiveDeclarations"
    <| fun () ->
        promise {
    ...
    <| fun () ->
        promise {
            ...
            let rec join (flavours: string list) = flavours |> String.concat ", "
                    ...
                    Html.div [
                        Bind.el2
                            ...
                            (fun (s, f) ->
                                ...
                                | (s, f) when f.Length > s ->
                                    text "Can't order more flavours than scoops!"
